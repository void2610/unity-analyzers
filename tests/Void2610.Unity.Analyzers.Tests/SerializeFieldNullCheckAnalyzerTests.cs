...
";
        ...
        [Fact]
        public async Task SerializeFieldEqualsNull_VUA0008()
        {
            // field == null → 検出
...
public class TestClass
{
    ...
    public void Method()
    {
        ...
        [Fact]
        public async Task SerializeFieldNotEqualsNull_VUA0008()
        {
            // field != null → 検出
            var test = SerializeFieldAttribute + @"
public class TestClass
{
    ...
    public void Method()
    {
        ...
        [Fact]
        public async Task NullEqualsSerializeField_VUA0008()
        {
            // null == field → 検出
            var test = SerializeFieldAttribute + @"
public class TestClass
{
    ...
    public void Method()
    {
        ...
        [Fact]
        public async Task SerializeFieldConditionalAccess_VUA0008()
        {
            // field?.Method() → 検出
            var test = SerializeFieldAttribute + @"
public class TestClass
{
    ...
    public void Method()
    {
        ...
        [Fact]
        public async Task SerializeFieldCoalesce_VUA0008()
        {
            // field ?? fallback → 検出
            var test = SerializeFieldAttribute + @"
public class TestClass
{
    ...
    public string Method() => {|#0:target ?? ""fallback""|};
        ...
        [Fact]
        public async Task SerializeFieldIsNull_VUA0008()
        {
            // field is null → 検出
            var test = SerializeFieldAttribute + @"
public class TestClass
{
    ...
    public void Method()
    {
        ...
        [Fact]
        public async Task SerializeFieldIsNotNull_VUA0008()
        {
